...
const appCategories: AppCategory[] = [
	...
	},
	{
		name: "Social",
		description:
			"Connect with the Ethereum community and manage your digital identity",
		apps: [
			{
				name: "Warpcast",
		...
		apps: [
			{
				...
				logo: "/apps/slice.png",
				href: "https://slice.so",
				description: "Food, drinks and merch, access discounts based on POAPs",
				imageClassName: "p-1"
			}
		]
	}
			...
			<div className="container mx-auto px-4">
				...
				<div className="space-y-16">
					{appCategories.map((category) => (
						<div key={category.name} className="backdrop-blur-sm p-6">
